...
lottie_animation = load_lottie_animation(
    "Cute Mascot Jumping Character.json"
)
...
with col_title:
    ...
    <div class="hero">
        ...
        <p>
            ...
            Escribe una frase y descubre cómo se comporta
            emocionalmente su lenguaje.
        </p>
...
with col_animation:
    ...
    if lottie_animation:
        ...
        st.warning(
            "No se encontró el archivo JSON de la animación."
        )
...
with info1:
    ...
    <div class="info-card">
        ...
        <div class="info-text">
            ...
            los valores negativos representan emociones
            negativas, mientras que los positivos representan
            emociones positivas.
...
with info2:
    ...
    <div class="info-card">
        ...
        <div class="info-text">
            ...
            0 es completamente objetivo y 1 es
...
text = st.text_input(
    ...
    placeholder=
    "Ejemplo: Me encanta esta experiencia, es increíble..."
...
if text:
    ...
    try:
        ...
        if polarity > 0:
            ...
            description = (
                "El texto presenta una orientación "
                "emocional favorable."
            )
            ...
            description = (
                "El texto no presenta una orientación "
                "emocional marcada."
            )
        ...
        <div class="result-card">
            ...
            <div class="sentiment {css_class}">
                {sentiment}
            </div>

            <div style="color:#b8c1dd;">
                {description}
            </div>
...
<div class="footer">
    ...
    SENTIMENT LAB ·
    TextBlob + Deep Translator + Streamlit
